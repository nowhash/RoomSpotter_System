...
include_once '../config.php';
   if(isset($_GET['fkey']))
   {
      ...
      $sql="select fkey,email from providers where fkey='$fkey'";
      ...
      {
         $sql="update providers set fkey= NULL where fkey='$fkey_verified'";
      ...
      if(!$uppercase || !$lowercase || !$number || !$specialChars || strlen($password) < 8) {
         ...
         $sql="UPDATE providers SET pass='$pass',c_pass='$c_pass' where email='$email'";
