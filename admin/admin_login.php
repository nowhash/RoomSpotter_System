      ...
      <div class="body-content">
         <div class="container" style="padding-right: 25%; padding-left: 25%;">
            <div class="container-backg">
               <div class="heading3" style="text-align: left; padding-bottom: 5;">Login</div>
               <font size="2px">Complete form below to Login for our service</font>
               <hr>
               <form action="ad_log_conn.php" method="POST">
                  <table border="0">
                     <tr>
                        <td>Email:</td>
