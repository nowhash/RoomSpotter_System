         ...
         <div class="container" style="padding-left: 15%; padding-right: 15%;">
            <div class="container-backg">
               ...
               <div class="user-homepage-btn">
                  ...
                  <button class="user-homepage active" onclick="location.href='applicants_registration.php';"><i
                        class="fas fa-user-cog"></i>&nbsp;Applicants</button>

                  <button class="user-homepage" onclick="location.href='providers_registration.php';"><i
                        class="fas fa-home"></i>&nbsp;Providers</button>

               </div>
               <?php include_once 'applicants_form.php' ?>
